...
const IconScript = () => {
  ...
  useEffect(() => {
    ...
    const observer = new MutationObserver((mutationsList, observer) => {
      if (document.querySelector('.color-fg-muted.f6.mt-2')) {
        addSvgIcon();
        observer.disconnect();
      }
    });
