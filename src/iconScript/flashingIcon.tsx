...
const FlashingIcon = (info) => {
    ...
    useEffect(() => {
        if (ghToken && shouldPoll) {
            try {
                ...
                fetchData(octokit, info, setIsFlashing, setShouldPoll, setIconHref, setHoverInfo);
    ...
    return (
        <div className="relative has-tooltip">
            <div className='tooltip absolute rounded shadow-lg p-1 bg-gray-600 text-dark-text left-full ml-2 top-0 whitespace-nowrap'>{isFlashing ? hoverInfo : 'No running workflow'}</div>
            <a href={`https://github.com/${info.ownerName}/${info.repoName}/actions/${iconHref}`} target="_blank" rel="noopener noreferrer">
