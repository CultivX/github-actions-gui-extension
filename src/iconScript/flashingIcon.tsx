...
const FlashingIcon = (info) => {
  ...
  return (
    <div className="relative has-tooltip">
      ...
      <a
        href={`https://github.com/${info.ownerName}/${info.repoName}/actions/${iconHref}`}
        target="_blank"
