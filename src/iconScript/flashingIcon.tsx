...
const FlashingIcon = (info) => {
    ...
    return (
        <div className="relative flex flex-col items-center has-tooltip">
            <div className='tooltip absolute rounded shadow-lg p-1 bg-gray-100 text-red-500 left-full ml-2 top-0 whitespace-nowrap'>{isFlashing ? hoverInfo : 'No running workflow'}</div>
