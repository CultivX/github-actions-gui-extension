...
const FlashingIcon = (info) => {
    ...
    const fetchData = async () => {
        setIsFlashing(await accessGitHub(info));
    };

    const accessGitHub = async (info) => {
        try {
            ...
            const hasRunning = data.workflow_runs.some(run => run.status === "in_progress" || run.status === "queued" || run.status === "waiting");

            console.log(hasRunning);
